...
# Version: 5.1.0
ARG ROOTFS_IMAGE=mendixdemoilease.azurecr.io/baseimages/app/mendix-rootfs:app
ARG BUILDER_ROOTFS_IMAGE=mendixdemoilease.azurecr.io/baseimages/builder/mendix-rootfs:builder
